...
# fear = visual.Movie("Fear and Loathing in Las Vegas",
...
#
#
# goodfellas = visual.Movie("Goodfellas",
...
#
# professional = visual.Movie("The Professional",
...
#
# terminator = visual.Movie("Terminator 2: Judgement Day",
...
#
# predator = visual.Movie("Predator",
...
#
# memories = visual.Movie("Memories of a Murder",
...
#                     )
#
# yellow = visual.Movie("The Yellow Sea",
...
# slc = visual.Movie("SLC Punk",
#                 "Youthful punks struggle with trying to find their place in the world.",
#                 "https://upload.wikimedia.org/wikipedia/en/a/a1/SLC_Punk.jpg",
#                 "https://www.youtube.com/watch?v=DILdeHgWF-U")
#
# sunshine = visual.Movie("Eternal Sunshine of the Spotless Mind",
#                         "A story about love.",
...
#
# tenenbaums = visual.Movie("The Royal Tenenbaums",
...
breaking = visual.Show("Breaking Bad",
...
venture = visual.Show("The Venture Bros.",
...
movies = [fear, assassins, sunshine]

shows = [venture, sunny, breaking, zrock, wire, walking]

#recommend = ["I saw the devil", 'Event Horizon']
recommend = [fear, assassins, sunshine]
